...
# polin = ' +'.join(polin)
# print(polin)
# with open(' polinom1.py', 'w') as pol1:
#  pol1.write(polin)
...
#mas ='Скоростные автомобильные дороги называются  абв автобанами.'
# mas = mas.split() # разбивает строку на отдельные значения [ 'fgh', 'kju', 'uyt']
# i = 0
# while i < len(mas):
#  if 'абв' in mas[i]: # Удаляем из списка элемент содержащий сочетание'абв'
#     del mas[i]
#  else:
#     i +=1
# print(mas)

# Вариант N 2 Если буквы стоят не подряд(абв)(автомобиль)
# mas = mas.split() # разбивает строку на отдельные значения [ 'fgh', 'kju', 'uyt']
# i = 0
# while i < len(mas):
#  if 'а'and 'б'and 'в' in mas[i]: # Удаляем из списка элемент содержащий 'а', 'б', 'в' в 
#                                  # любой комбинации
#     del mas[i]
#  else:
#     i +=1
...
# Первый игрок начинает и выигрывает
...
#    global turn 
#    game[b] = 'x'
#    buttons[b].config(text = 'x',state = 'desable')
...
# # Это название
# buttons = [Button(width = 5, height=2, font=('Arial',20,'bold'), command = lambda x = i:
#         push(x)) for i in range(9)]
# # Это создание кнопок
# label.grid(row = 0, column =0, columnspan =3)# задаем начало.метод grid.
# row = 1; col = 0
# for i in range(9):
...
#   row += 1
#   col = 0
# # Это расположение кнопок на игровом поле. С лева на право построчно.
# root.mainloop()
# #print(push) # Код еще не отлажен.

##############################################################################
#
# 4 Реализуйте RLE алгоритм: реализуйте модуль сжатия и восстановления данных. 
# str = [1,1,1,0,0,0,1,1,1,0]
# def rle(str):
#         result = []
#         count = 0
